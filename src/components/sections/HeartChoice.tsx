...
function OrangeCard({
  ...
  return (
    <div style={{ position: "absolute", backgroundColor: ORANGE, padding: "2rem 2.25rem", zIndex: 4, ...style }}>
      <div style={{ display: "flex", alignItems: "flex-start", gap: "1rem", marginBottom: "1.25rem" }}>
        <Html as="h2" html={title} style={{ fontFamily: "var(--font-title)", fontSize: "clamp(1.5rem, 2.2vw, 2rem)", fontWeight: 700, lineHeight: 1, letterSpacing: "-0.02em", color: "#191919" }} />
      </div>
      <BodyParagraphs content={body} style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", lineHeight: 1.3, color: "#191919", fontWeight: 500 }} />
    </div>
  );
}
  ...
  return (
    <section style={{ width: "100vw", height: "100vh", flexShrink: 0, position: "relative", overflow: "hidden", backgroundColor: bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ position: "relative", width: "70%", flexShrink: 0 }}>
        <Image src={hcSite} alt="Heart Choice website" style={{ width: "100%", height: "auto", display: "block" }} />
      </div>
      <OrangeCard title={t.raw("s1.title") as string} body={t.raw("s1.body") as string | string[]} style={{ top: "8%", right: "7rem", width: "clamp(280px, 28vw, 400px)" }} />
    </section>
  );
}
...
function Section2({
  ...
  const bg = isDark ? "#0f0f0f" : "#f0ede8";
  return (
    <section style={{ width: "100vw", height: "100vh", flexShrink: 0, position: "relative", overflow: "hidden", backgroundColor: bg }}>
      <div style={{ position: "absolute", right: 0, top: 0, height: "100%", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <Image src={hcNotepad} alt="Heart Choice brand notepad" style={{ objectFit: "contain", objectPosition: "center", height: "70%" }} />
      </div>
      <div style={{ position: "absolute", left: "10rem", top: "50%", transform: "translateY(-50%)", width: "clamp(220px, 32vw, 440px)", zIndex: 2 }}>
        <Image src={hcHC00} alt="Heart Choice brand identity" style={{ width: "100%", height: "auto", display: "block" }} />
      </div>
      <OrangeCard title={t.raw("s2.title") as string} body={t.raw("s2.body") as string | string[]} style={{ top: "6%", right: "15rem", width: "clamp(260px, 26vw, 400px)", zIndex: 5 }} />
    </section>
  );
}
...
function Section3({
  ...
  return (
    <section style={{ width: "100vw", height: "100vh", flexShrink: 0, position: "relative", overflow: "hidden", backgroundColor: bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ width: "75vw", height: "70vh", display: "flex", gap: "1rem", flexShrink: 0 }}>
        <div style={{ width: "50%", height: "100%", display: "flex", flexDirection: "column", gap: "1rem" }}>
          <div style={{ flex: 1, display: "flex", gap: "1rem", overflow: "hidden", alignItems: "flex-end" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={hc013.src} alt="" style={{ width: "50%", height: "auto", display: "block" }} />
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={hc014.src} alt="" style={{ width: "50%", height: "auto", display: "block" }} />
          </div>
          <div style={{ flex: 1.15, overflow: "hidden" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={hc012.src} alt="" style={{ width: "100%", height: "auto", display: "block" }} />
          </div>
        </div>
        <div style={{ width: "50%", height: "100%", overflow: "hidden" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={hc015.src} alt="" style={{ width: "100%", height: "auto", display: "block" }} />
        </div>
      </div>
      <div style={{ position: "absolute", bottom: "8rem", left: "70%", transform: "translateX(-50%)", zIndex: 3, backgroundColor: CARD_BG, padding: "2.5rem 4.25rem", width: "clamp(560px, 66vw, 960px)", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2.5rem" }}>
        <div>
          <Html as="h4" html={t.raw("s3.col1_title") as string} style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", fontWeight: 700, letterSpacing: "0.05em", textTransform: "uppercase", color: ORANGE, marginBottom: "1rem" }} />
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            {col1Points.map((point, i) => (
              <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: "0.6rem" }}>
                <ArrowDecor direction="right" size={9} style={{ flexShrink: 0, marginTop: "0.25rem" }} />
                <p dangerouslySetInnerHTML={{ __html: point }} style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", lineHeight: 1.65, color: textMuted }} />
              </div>
            ))}
          </div>
        </div>
        <div>
          <Html as="h4" html={t.raw("s3.col2_title") as string} style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", fontWeight: 700, letterSpacing: "0.05em", textTransform: "uppercase", color: ORANGE, marginBottom: "1rem" }} />
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            {col2Points.map((point, i) => (
              <p key={i} dangerouslySetInnerHTML={{ __html: point }} style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", lineHeight: 1.65, color: textMuted }} />
            ))}
          </div>
        </div>
      </div>
...
function ZigzagLine() {
  return (
    <svg viewBox="0 0 72 14" width="72" height="14" style={{ display: "block", flexShrink: 0, margin: "0.5rem 0" }}>
      <polyline points="0,10 12,4 24,10 36,4 48,10 60,4 72,10" stroke={ORANGE} strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function Section4({
  ...
  return (
    <section style={{ width: "100vw", height: "100vh", flexShrink: 0, position: "relative", overflow: "hidden", backgroundColor: bg, display: "flex", alignItems: "stretch" }}>
      <div style={{ width: "44%", flexShrink: 0, display: "flex", flexDirection: "column", justifyContent: "center", padding: "4rem 3rem 4rem 5rem", gap: "1.75rem", zIndex: 2 }}>
        <div style={{ backgroundColor: CARD_BG, padding: "1.75rem 2rem" }}>
          <p style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", fontWeight: 500, color: labelColor, letterSpacing: "0.03em", marginBottom: "1.5rem" }}>{t("s4.stats_intro")}</p>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1rem" }}>
            {stats.map((s, i) => (
              <div key={i} style={{ display: "flex", flexDirection: "column" }}>
                <span style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-xs)", fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: labelColor, marginBottom: "0.4rem" }}>{s.label}</span>
                <span style={{ fontFamily: "var(--font-title)", fontSize: "clamp(0.9rem, 1.2vw, 1rem)", fontWeight: 700, lineHeight: 1, color: "#ffffff" }}>{s.from}</span>
                <ZigzagLine />
                <span style={{ fontFamily: "var(--font-title)", fontSize: "clamp(1.2rem, 1.8vw, 1.7rem)", fontWeight: 700, lineHeight: 1, color: ORANGE }}>{s.to}</span>
              </div>
            ))}
          </div>
        </div>
        <p style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", lineHeight: 1.75, color: textMuted, maxWidth: "40ch" }}>{t("s4.description")}</p>
      </div>
      <div style={{ flex: 1, display: "flex", alignItems: "center", padding: "4rem 4rem 4rem 2rem" }}>
        <div style={{ width: "100%", height: "100%", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gridTemplateRows: "repeat(2, 1fr)", gap: "1rem" }}>
...
function MobileSection1({ t, isDark, sectionRef }: { t: T; isDark: boolean; sectionRef: SectionRef }) {
  ...
  return (
    <section ref={sectionRef} style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", backgroundColor: bg, overflow: "hidden" }}>
      {/* Site screenshot */}
      <div style={{ height: "45vh", flexShrink: 0, position: "relative", overflow: "hidden" }}>
        <Image src={hcSite} alt="Heart Choice website" fill style={{ objectFit: "contain", objectPosition: "center" }} sizes="100vw" priority />
      </div>

      {/* Orange card */}
      <div style={{ padding: "2rem 1.25rem 3rem", display: "flex", flexDirection: "column", gap: "0" }}>
...
function MobileSection2({ t, isDark, sectionRef }: { t: T; isDark: boolean; sectionRef: SectionRef }) {
  ...
  return (
    <section ref={sectionRef} style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", backgroundColor: bg, overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", padding: "4.5rem 2rem 1.5rem" }}>
        <Image src={hcHC00} alt="Heart Choice brand identity" style={{ width: "70%", height: "auto", display: "block" }} />
      </div>

      {/* Notepad image (small) */}
      <div style={{ display: "flex", justifyContent: "center", padding: "0 2rem 1.5rem" }}>
        <Image src={hcNotepad} alt="Heart Choice notepad" style={{ width: "55%", height: "auto", display: "block" }} />
      </div>
...
function MobileSection3({ t, isDark, sectionRef }: { t: T; isDark: boolean; sectionRef: SectionRef }) {
  ...
  return (
    <section ref={sectionRef} style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", backgroundColor: bg, overflow: "hidden" }}>
      ...
      {/* Dark text card */}
      <div style={{ flex: 1, padding: "0 1.25rem 3rem", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
...
function MobileSection4({ t, isDark, sectionRef }: { t: T; isDark: boolean; sectionRef: SectionRef }) {
  ...
  return (
    <section ref={sectionRef} style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", backgroundColor: bg, overflow: "hidden" }}>
      <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "1.25rem", padding: "4.5rem 1.25rem 3rem" }}>
        {/* Stats card */}
        <div style={{ backgroundColor: CARD_BG, padding: "1.5rem" }}>
          <p style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", fontWeight: 500, color: labelColor, marginBottom: "1.25rem" }}>{t("s4.stats_intro")}</p>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0.75rem" }}>
            {stats.map((s, i) => (
              <div key={i} style={{ display: "flex", flexDirection: "column" }}>
                <span style={{ fontFamily: "var(--font-body)", fontSize: "0.6rem", fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: labelColor, marginBottom: "0.4rem" }}>{s.label}</span>
                <span style={{ fontFamily: "var(--font-title)", fontSize: "0.85rem", fontWeight: 700, lineHeight: 1, color: "#ffffff" }}>{s.from}</span>
                <ZigzagLine />
                <span style={{ fontFamily: "var(--font-title)", fontSize: "1.1rem", fontWeight: 700, lineHeight: 1, color: ORANGE }}>{s.to}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Description */}
        <p style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", lineHeight: 1.75, color: textMuted }}>{t("s4.description")}</p>

        {/* Image grid */}
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gridTemplateRows: "repeat(2, 1fr)", gap: "0.5rem", height: "42vh" }}>
          {IMG_MOSAIC.map((img, i) => (
            <div key={i} style={{ overflow: "hidden", borderRadius: "2px" }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={img.src} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
