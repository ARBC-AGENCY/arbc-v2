  ...
  return (
    <section style={{ width: "100vw", height: "100vh", flexShrink: 0, position: "relative", overflow: "hidden", backgroundColor: bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ position: "relative", width: "70%", flexShrink: 0 }}>
        <Image src={lL00} alt="Liji" style={{ width: "100%", height: "auto", display: "block" }} />
      </div>
      <div style={{ position: "absolute", bottom: "6%", right: "7rem", width: "clamp(280px, 30vw, 440px)", backgroundColor: CARD_BG, padding: "2rem 2.25rem", zIndex: 4 }}>
...
function Section2({
  ...
  return (
    <section style={{ width: "100vw", height: "100vh", flexShrink: 0, position: "relative", overflow: "hidden", backgroundColor: bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ position: "relative", width: "70%", flexShrink: 0, marginRight: "1%" }}>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={lL000.src} alt="Liji Campaign" style={{ width: "70%", height: "auto", display: "block" }} />
      </div>
      <div style={{ position: "absolute", top: "15%", right: "25rem", width: "clamp(260px, 28vw, 400px)", backgroundColor: ORANGE, padding: "2rem 2.25rem", zIndex: 4 }}>
        <p style={{ fontFamily: "var(--font-title)", fontSize: "var(--text-md)", fontWeight: 700, lineHeight: 1, color: "#191919", marginBottom: "1rem" }} dangerouslySetInnerHTML={{ __html: t.raw("s2.title") as string }} />
...
function Section3({
  ...
  return (
    <section style={{ width: "100vw", height: "100vh", flexShrink: 0, position: "relative", overflow: "hidden", backgroundColor: bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ width: "100vw", height: "70%", flexShrink: 0, position: "relative", overflow: "hidden", backgroundColor: bg, display: "flex", alignItems: "flex-end", gap: "1rem" }}>
        <div style={{ width: "30%", flexShrink: 0, display: "flex", flexDirection: "column", justifyContent: "center", padding: "4rem 2rem 4rem 5rem", gap: "1.5rem" }}>
          {(["p1", "p2"] as const).map((key) => (
            <div key={key} style={{ backgroundColor: CARD_BG, padding: "1.25rem 1.5rem" }}>
              <div style={{ display: "flex", alignItems: "flex-start", gap: "0.6rem", marginBottom: "0.5rem" }}>
                ...
                <span style={{ fontFamily: "var(--font-title)", fontSize: "var(--text-sm)", fontWeight: 700, color: "#ffffff", lineHeight: 1.2 }}>{t(`s3.${key}_title`)}</span>
              </div>
              <p style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", lineHeight: 1.6, color: textMuted, margin: 0 }}>{t(`s3.${key}_body`)}</p>
            </div>
          ))}
        </div>
        <div style={{ width: "20%", flexShrink: 0, display: "flex", alignItems: "center", overflow: "hidden" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={lL4.src} alt="Liji Look 4" style={{ width: "100%", height: "auto", display: "block" }} />
        </div>
        <div style={{ width: "15%", flexShrink: 0, display: "flex", flexDirection: "column", justifyContent: "center", gap: "1rem" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={lL2.src} alt="Liji Look 2" style={{ width: "100%", height: "auto", display: "block" }} />
          <div style={{ display: "flex", gap: "0.5rem" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={lL1.src} alt="Liji Look 1" style={{ width: "50%", height: "auto", display: "block" }} />
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={lL6.src} alt="Liji Look 6" style={{ width: "50%", height: "auto", display: "block" }} />
          </div>
        </div>
        <div style={{ width: "25%", display: "flex", flexDirection: "column" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={lL3.src} alt="Liji Look 3" style={{ width: "100%", height: "auto", display: "block" }} />
        </div>
      </div>
    </section>
  );
...
function Section4({
  ...
  return (
    <section style={{ width: "100vw", height: "100vh", flexShrink: 0, position: "relative", overflow: "hidden", backgroundColor: bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ width: "100vw", height: "60%", flexShrink: 0, position: "relative", overflow: "visible", backgroundColor: bg, display: "flex", alignItems: "center", justifyContent: "center", gap: "1rem" }}>
        <div style={{ width: "30%", flexShrink: 0, display: "flex", alignItems: "center", overflow: "visible" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={lBabyBoxeur.src} alt="Post Liji Bébé Boxeur" style={{ width: "100%", height: "auto", display: "block" }} />
        </div>
        <div style={{ width: "15%", flexShrink: 0, display: "flex", flexDirection: "column" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={lBabyEspion.src} alt="Bébé Espion 2" style={{ width: "100%", height: "auto", display: "block" }} />
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={lCrushCrush.src} alt="Crush Crush X LIJI" style={{ width: "100%", height: "auto", display: "block" }} />
        </div>
        <div style={{ width: "35%", display: "flex", flexDirection: "column", gap: "1rem" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={lCoverFb.src} alt="Cover Facebook Liji" style={{ width: "100%", height: "auto", display: "block" }} />
  ...
  return (
    <section ref={sectionRef} style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", backgroundColor: bg, overflow: "hidden" }}>
      ...
      <div style={{ height: "48vh", flexShrink: 0, position: "relative", overflow: "hidden" }}>
        <Image src={lL00} alt="Liji" fill style={{ objectFit: "contain", objectPosition: "center" }} sizes="100vw" priority />
      </div>
...
function MobileSection2({ t, isDark, sectionRef }: { t: T; isDark: boolean; sectionRef: SectionRef }) {
  ...
  return (
    <section ref={sectionRef} style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", backgroundColor: bg, overflow: "hidden" }}>
      {/* Campaign image */}
      <div style={{ height: "42vh", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", padding: "4.5rem 1.25rem 1rem" }}>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={lL000.src} alt="Liji Campaign" style={{ maxWidth: "100%", maxHeight: "100%", height: "auto", display: "block" }} />
      </div>

      {/* Orange card */}
      <div style={{ padding: "0 1.25rem 3rem" }}>
        <div style={{ backgroundColor: ORANGE, padding: "1.75rem 1.75rem" }}>
          <p style={{ fontFamily: "var(--font-title)", fontSize: "clamp(1.1rem, 4vw, 1.5rem)", fontWeight: 700, lineHeight: 1, color: "#191919", marginBottom: "1rem" }} dangerouslySetInnerHTML={{ __html: t.raw("s2.title") as string }} />
          <BodyParagraphs content={t.raw("s2.body") as string | string[]} style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", lineHeight: 1.3, color: "#191919", fontWeight: 500 }} />
        </div>
      </div>
    </section>
...
function MobileSection3({ t, isDark, sectionRef }: { t: T; isDark: boolean; sectionRef: SectionRef }) {
  ...
  return (
    <section ref={sectionRef} style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", backgroundColor: bg, overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", gap: "0.5rem", padding: "4.5rem 1.25rem 1rem", alignItems: "flex-end" }}>
        {/* L4 — tall main image */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={lL4.src} alt="Liji Look 4" style={{ width: "35%", height: "auto", display: "block", flexShrink: 0 }} />
      ...
      {/* 2 text cards */}
      <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "0.75rem", padding: "1rem 1.25rem 3rem" }}>
        {(["p1", "p2"] as const).map((key) => (
          <div key={key} style={{ backgroundColor: CARD_BG, padding: "1.25rem 1.5rem" }}>
            <div style={{ display: "flex", alignItems: "flex-start", gap: "0.6rem", marginBottom: "0.5rem" }}>
              <ArrowDecor direction="right" size={9} style={{ flexShrink: 0, marginTop: "0.2rem" }} />
  ...
  return (
    <section ref={sectionRef} style={{ minHeight: "100dvh", display: "flex", flexDirection: "column", backgroundColor: bg, overflow: "hidden" }}>
      ...
      <div style={{ height: "38vh", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", padding: "4.5rem 1.25rem 1rem" }}>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={lBabyBoxeur.src} alt="Post Liji Bébé Boxeur" style={{ maxHeight: "100%", width: "auto", display: "block" }} />
      </div>

      {/* BabyEspion + CrushCrush */}
      <div style={{ display: "flex", gap: "0.5rem", padding: "0 1.25rem 1rem" }}>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={lBabyEspion.src} alt="Bébé Espion 2" style={{ width: "50%", height: "auto", display: "block" }} />
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={lCrushCrush.src} alt="Crush Crush X LIJI" style={{ width: "50%", height: "auto", display: "block" }} />
      </div>
